...
class OCC_Internals {
 ...
 public:
  ...
  void bind(TopoDS_Edge edge, int num);
  ...
  bool compareEdges(const TopoDS_Edge& e1, const TopoDS_Edge& e2);
  bool areEquals(const TopoDS_Vertex& v1,
