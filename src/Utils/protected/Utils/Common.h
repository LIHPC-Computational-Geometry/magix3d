...
extern "C"
{
  /*! Affichage d'un message indiquant que la fonction n'est pas encore impl�ment�. */
  void MgxNotYetImplemented(const char*,const char*,unsigned int,const char*);
  /*! Affichage d'un message indiquant que la fonction est obsol�te. */
 ...
 * @param		type est le niveau de trace souhait�
 */
