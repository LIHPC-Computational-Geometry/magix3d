...
{
    if (!m_initWithArm1 && m_raison<=0.0){
...
/*----------------------------------------------------------------------------*/
EdgeMeshingPropertyGeometric::
EdgeMeshingPropertyGeometric(int nbBras, double raison, Utils::Math::Point polar_center, bool isDirect, bool initWithFirstEdge, double meshingEdgeLength)
