...
_autoUpdateUsesSelection ("autoUpdateUsesSelection", true, "Les panneaux d'opérations doivent ils être initialisés (autant que possible) avec la sélection en cours lors de leur affichage ? Oui si true (défaut), non si false (expérimental)."),
