/*----------------------------------------------------------------------------*/
/** \file StandardGeomRepresentation.h
 *
 ...
 */
/*----------------------------------------------------------------------------*/
#ifndef MGX3D_GEOM_STANDARD_VERTEX_GEOM_REPRESENTATION_H_
#define MGX3D_GEOM_STANDARD_VERTEX_GEOM_REPRESENTATION_H_
/*----------------------------------------------------------------------------*/
...
/*----------------------------------------------------------------------------*/
/**
 * \class StandardVertexGeomRepresentation
 *
 * \brief Calcul des propriétés géométriques d'un sommet géométrique géré en
 *        interne à Mgx3D.
 *
 */
class StandardVertexGeomRepresentation: public GeomRepresentation{
...
public:
    ...
    /** \brief  Destructeur
     */
    virtual ~StandardVertexGeomRepresentation();
...
//    void updateShape(GeomEntity* e);
     ...
     */
    virtual double getPrecision() {return 0.0;}


    Utils::Math::Point getPoint() const {return m_coord;}

    double getX() const {return m_coord.getX();}

    double getY() const {return m_coord.getY();}

    double getZ() const {return m_coord.getZ();}
private:

    Internal::Context & m_context;
    /// Coordonnées du sommet géométrique
...
/*----------------------------------------------------------------------------*/
#endif /* MGX3D_GEOM_STANDARD_VERTEX_GEOM_REPRESENTATION_H_ */
/*----------------------------------------------------------------------------*/
