 ...
 */
/*----------------------------------------------------------------------------*/
#ifndef MGX3D_GEOM_FACETEDVERTEX_H_
#define MGX3D_GEOM_FACETEDVERTEX_H_
/*----------------------------------------------------------------------------*/
 ...
 * \class FacetedVertex
 *
 * \brief Propriétés géométriques d'un objet 0D facétisé (un noeud GMDS)
 */
class FacetedVertex: public GeomRepresentation{
...
public:
    ...
    /** \brief  Constructeur
     */
	FacetedVertex(Internal::Context& c, uint gmds_id, gmds::Node node);

	/*------------------------------------------------------------------------*/
	/** \brief  Constructeur par copie
	 */
	FacetedVertex(const FacetedVertex& rep);

	/*------------------------------------------------------------------------*/
	/** \brief  Destructeur
	 */
	virtual ~FacetedVertex();
    ...
    /// accès au noeud du sommet
    gmds::Node& getGMDSNode() {return m_node;}
...
/*----------------------------------------------------------------------------*/
#endif /* MGX3D_GEOM_FACETEDVERTEX_H_ */
/*----------------------------------------------------------------------------*/
