 ...
 *  Sur un cas comme Job34 qui met près d'une minute pour s'exécuter
 *  On a compté près d'un dixième de seconde pour la recherche des entités en fonction des noms
 *  Donc cette recherche reste négligeable.
 */
#ifdef _DEBUG_TIMER
