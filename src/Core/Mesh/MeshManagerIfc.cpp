...
/*----------------------------------------------------------------------------*/
Internal::M3DCommandResultIfc* MeshManagerIfc::exportBlocksForCGNS(const std::string& n)
{
    throw TkUtil::Exception (TkUtil::UTF8String ("MeshManagerIfc::exportBlocksForCGNS should be overloaded.", TkUtil::Charset::UTF_8));
}
/*----------------------------------------------------------------------------*/
} // end namespace Mesh
/*----------------------------------------------------------------------------*/
