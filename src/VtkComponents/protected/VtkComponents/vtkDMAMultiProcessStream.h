/**
 * Classe vtkMultiProcessStream dont les assert en cas d'erreur de type 
 * attendu au niveau du flux sont remplacés par des levée d'exception.
 *
 * Classe issue de vtkMultiProcessStream de VTK 7.1.1
 */
...
/*=========================================================================
  ...
  Module:    vtkDMAMultiProcessStream.h
...
#ifndef vtkDMAMultiProcessStream_h
#define vtkDMAMultiProcessStream_h
...
//class VTKPARALLELCORE_EXPORT vtkDMAMultiProcessStream
class vtkDMAMultiProcessStream
{
public:
  vtkDMAMultiProcessStream();
  vtkDMAMultiProcessStream(const vtkDMAMultiProcessStream&);
  ~vtkDMAMultiProcessStream();
  vtkDMAMultiProcessStream& operator=(const vtkDMAMultiProcessStream&);

  //@{
  /**
   * Add-to-stream operators. Adds to the end of the stream.
   */
  vtkDMAMultiProcessStream& operator << (double value);
  vtkDMAMultiProcessStream& operator << (float value);
  vtkDMAMultiProcessStream& operator << (int value);
  vtkDMAMultiProcessStream& operator << (char value);
#ifndef VTK_5	// CP
  vtkDMAMultiProcessStream& operator << (bool value);
#endif	// VTK_5
  vtkDMAMultiProcessStream& operator << (unsigned int value);
  vtkDMAMultiProcessStream& operator << (unsigned char value);
  vtkDMAMultiProcessStream& operator << (vtkTypeInt64 value);	// POSE PB => PREFERER int
  vtkDMAMultiProcessStream& operator << (vtkTypeUInt64 value);	// POSE PB => PREFERER unsigned int
  vtkDMAMultiProcessStream& operator << (const std::string& value);
  // Without this operator, the compiler would convert
  // a char* to a bool instead of a std::string.
#ifndef VTK_5	// CP
  vtkDMAMultiProcessStream& operator << (const char* value);
#endif
  vtkDMAMultiProcessStream& operator << (const vtkDMAMultiProcessStream&);
  //@}
  ...
  vtkDMAMultiProcessStream& operator >> (vtkTypeInt64 &value);	// POSE PB => PREFERER int
  vtkDMAMultiProcessStream& operator >> (vtkTypeUInt64 &value);	// POSE PB => PREFERER unsigned int
  vtkDMAMultiProcessStream& operator >> (std::string &value);
  vtkDMAMultiProcessStream& operator >> (vtkDMAMultiProcessStream&);
  //@}
...
// VTK-HeaderTest-Exclude: vtkDMAMultiProcessStream.h
