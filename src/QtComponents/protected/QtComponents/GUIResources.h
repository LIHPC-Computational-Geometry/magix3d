...
#ifndef MAGIX3D_GUIRESOURCES_H
#define MAGIX3D_GUIRESOURCES_H
...
class GUIResources
{
	...
	GUIResources ( );
	GUIResources (const GUIResources&);
	GUIResources& operator = (const GUIResources&);
	~GUIResources ( );
	static GUIResources*	_instance;
};	// class GUIResources
