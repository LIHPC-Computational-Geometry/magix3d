	  ...
	  _buttonGroup (0), _factorRadioButton (0), _factorTextField (0), _firstEdgeLengthRadioButton (0), _firstEdgeLengthTextField(0), _orientationCheckBox (0)
{
	...
	_factorRadioButton = new QRadioButton("Raison :", this);
	hlayout->addWidget (_factorRadioButton);
	_buttonGroup->addButton(_factorRadioButton);
	_factorRadioButton->setChecked (true);
	connect (_factorRadioButton, SIGNAL(clicked()), this,
	         SLOT (factorRadioButtonSelected ( )));
...
QtGeometricProgressionPanel::QtGeometricProgressionPanel (
	...
	: QtDiscretisationPanelIfc (
		0, *new QtMgx3DMainWindow(0)),
	  _buttonGroup (0), _factorRadioButton (0), _firstEdgeLengthRadioButton (0),
	  _factorTextField (0), _firstEdgeLengthTextField (0), _orientationCheckBox (0)
{
											...
											const CoEdgeMeshingProperty& cemp)
{
	...
	_factorRadioButton->setChecked(!properties->initWithFirstEdge());
...
double QtGeometricProgressionPanel::getFirstEdgeLength ( ) const
{
	CHECK_NULL_PTR_ERROR (_firstEdgeLengthTextField)
	return _firstEdgeLengthTextField->getValue ( );
}	// QtGeometricProgressionPanel::getFirstEdgeLength
					...
					QtGeometricProgressionPanel::getMeshingProperty ( size_t edgeNum ) const
{
	...
	if (isPolarCut())
		emp = new EdgeMeshingPropertyGeometric (
				...
				!invertOrientation ( ), initWithFirstEdgeLength(), getFirstEdgeLength());
	else
		emp = new EdgeMeshingPropertyGeometric (
				edgeNum, getFactor ( ),
				!invertOrientation ( ), initWithFirstEdgeLength(), getFirstEdgeLength());
