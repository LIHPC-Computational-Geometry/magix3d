//
// Created by calderans on 21/07/2026.
//
...
GUIResources*	GUIResources::_instance	= 0;
...
{
	GUIResources::_instance	= this;


GUIResources::GUIResources (const GUIResources&)
: _displayUpdatesErrors (true),
_defaultConfigURL (""),
_userConfigURL (""),
_userConfigPatchsURL (""),
...
_scripts ( )
{
	MGX_FORBIDDEN ("GUIResources copy constructor is not allowed.");
}	// GUIResources::GUIResources (const GUIResources&)


GUIResources& GUIResources::operator = (const GUIResources&)
{
	MGX_FORBIDDEN ("GUIResources assignment operator is not allowed.");
	return *this;
}	// GUIResources::GUIResources (const GUIResources&)
...
GUIResources& GUIResources::instance ( )
{
	if (0 == _instance)
		_instance	= new GUIResources ( );
