...
//	_meshingToolbar->addAction (getActions ( )._meshAction);
		...
		void QtMgx3DMainWindow::createActions()
		{
			...
			connect (_actions._longCommandAction, SIGNAL (triggered ( )), this, SLOT (longCommandCallback ( )), defaultConnectionType);
			...
			connect (_actions._openCascadeLongCommandAction, SIGNAL (triggered ( )), this, SLOT (openCascadeLongCommandCallback ( )), defaultConnectionType);
#endif
